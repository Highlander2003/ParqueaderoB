Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      post "parking_lot/:parking_lot_name/vehicle_park", to: "parking_lot#vehicle_park", as: :park
      delete "parking_lot/:parking_lot_name/vehicle_remove/:vehicle_plate", to: "parking_lot#vehicle_remove", as: :remove
    end
  end
end
